...
export const MOVE_CATEGORIES: MoveCategory[] = [
  ...
  },
  {
    ...
    moves: [
      ...
      { name: "Close Combat", nameFr: "Close Combat", type: "Fighting", category: "Physical", power: 120, accuracy: 100, pp: 5, effect: "-1 Déf, -1 Déf.Spé après utilisation.", competitiveNotes: "La meilleure attaque physique Combat. 120 puissance sans restriction. Le drawback est acceptable car tu veux KO, pas tanker." },
      ...
      { name: "Ice Beam", nameFr: "Laser Glace", type: "Ice", category: "Special", power: 90, accuracy: 100, pp: 10, effect: "10% chance de gel.", competitiveNotes: "Coverage Glace essentielle. Touche Dragon, Sol, Vol, Plante. BoltBeam (Thunderbolt + Ice Beam) est le combo coverage classique." },
      ...
      { name: "Earthquake", nameFr: "Séisme", type: "Ground", category: "Physical", power: 100, accuracy: 100, pp: 10, effect: "Touche tous les Pokémon adjacents en Doubles.", competitiveNotes: "La meilleure attaque physique non-restrictive. 100 puissance, 100 précision, aucun drawback. Attention en Doubles : touche aussi l'allié!" },
